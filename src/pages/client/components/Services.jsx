...
export default function Services() {
  const data = [
    ...
    {
      icon: service3,
      title: "Convenient Standing Reservation ",
      subTitle:
        "Reserve Standing spaces conveniently through our platform, ensuring easy access to the venue and saving you time upon arrival.",
    },
    {
      icon: service4,
